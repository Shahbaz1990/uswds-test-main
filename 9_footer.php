    ...
    <div class="usa-footer__primary-section bg-primary-dark">
        <nav class="usa-footer__nav" aria-label="Footer navigation">
            <ul class="grid-row grid-gap">
                ...
                <li
                    class="tablet:grid-col-auto desktop:grid-col-auto usa-footer__primary-content">
                    <a class="usa-footer__primary-link text-white" href="about.php">About Us</a>
                </li>
                <li
                    class="tablet:grid-col-auto desktop:grid-col-auto usa-footer__primary-content">
                ...
                <li
                    class="tablet:grid-col-auto desktop:grid-col-auto usa-footer__primary-content">
                    <a class="usa-footer__primary-link text-white" href="blog-list.php">News</a>
                </li>
                <li
                    class="tablet:grid-col-auto desktop:grid-col-auto usa-footer__primary-content">
                    <a class="usa-footer__primary-link text-white" href="events-list.php">Events</a>
                </li>
                <li
                    class="tablet:grid-col-auto desktop:grid-col-auto usa-footer__primary-content">
                    <a class="usa-footer__primary-link text-white" href="contact.php">Contact Us</a>
                </li>
            </ul>
        </nav>
    </div>
